...
from backend.chord_dht.storage import engine  # Asegúrate de que DB apunte a la base de datos SQLite
...
class HandleData:
    ...
    def data(self, delete: bool, id=None) -> str:
        ...
        for user in users:
            user_id = set_id(user.email)  # Usamos el email para generar el ID
